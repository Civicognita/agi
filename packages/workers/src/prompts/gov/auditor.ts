...
export const govAuditor: WorkerDefinition = {
  ...
  domain: "gov",
  role: "auditor",
  description: "Compliance and verification worker. Audits COA chains, verifies seals, checks policy compliance, and validates governance structures. Always followed by gov.archivist.",
  modelTier: "capable",
  allowedTools: ["Read", "Bash", "Glob", "Grep"],
  chainTarget: "gov.archivist",
  requiredTier: "sealed",
  keywords: ["audit", "compliance", "verify", "governance", "COA chain", "seal", "policy check", "authorization", "validate", "security audit"],
  prompt: `---
