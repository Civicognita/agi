...
export const govArchivist: WorkerDefinition = {
  id: "gov.archivist",
  name: "Governance Archivist",
  domain: "gov",
  role: "archivist",
  description: "Seal management and record keeping worker. Creates seals for audited entities, maintains the archive, and ensures governance records are properly stored.",
  modelTier: "fast",
  allowedTools: ["Read", "Write", "Glob", "Grep"],
  keywords: ["archive", "seal", "record", "store", "index", "governance records", "audit trail", "sign", "append-only"],
  prompt: `---
