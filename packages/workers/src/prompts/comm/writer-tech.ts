...
export const commWriterTech: WorkerDefinition = {
  ...
  domain: "comm",
  role: "writer-tech",
  description: "Technical documentation worker. Writes API docs, code comments, README files, and technical guides. Always followed by comm.editor in the enforced chain.",
  modelTier: "balanced",
  allowedTools: ["Read", "Write", "Edit", "Glob", "Grep"],
  chainTarget: "comm.editor",
  keywords: ["document", "docs", "README", "API docs", "JSDoc", "technical writing", "guide", "changelog", "reference"],
  prompt: `---
