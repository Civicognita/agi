...
export const commEditor: WorkerDefinition = {
  ...
  domain: "comm",
  role: "editor",
  description: "Style and consistency editor. Reviews and refines written content for clarity, grammar, and style. Automatically follows comm writers in the enforced chain.",
  modelTier: "fast",
  allowedTools: ["Read", "Edit", "Glob", "Grep"],
  keywords: ["edit", "proofread", "grammar", "style", "polish", "review text", "clarity", "consistency", "spelling", "terminology"],
  prompt: `---
