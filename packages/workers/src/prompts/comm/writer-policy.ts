...
export const commWriterPolicy: WorkerDefinition = {
  ...
  domain: "comm",
  role: "writer-policy",
  description: "Governance and policy documentation worker. Writes procedures, guidelines, compliance documents, and organizational policies. Always followed by comm.editor.",
  modelTier: "balanced",
  allowedTools: ["Read", "Write", "Edit", "Glob", "Grep"],
  chainTarget: "comm.editor",
  keywords: ["policy", "governance", "compliance", "procedure", "guideline", "ADR", "standard", "decision record", "rules", "protocol"],
  prompt: `---
