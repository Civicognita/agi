...
export const codeTester: WorkerDefinition = {
  ...
  domain: "code",
  role: "tester",
  description: "Test worker that validates code hacker output. Automatically follows hacker in enforced chain. Writes and runs tests following existing patterns.",
  modelTier: "fast",
  allowedTools: ["Read", "Write", "Bash", "Glob", "Grep"],
  keywords: ["test", "validate", "verify", "unit test", "integration test", "coverage", "spec", "test suite"],
  prompt: `---
