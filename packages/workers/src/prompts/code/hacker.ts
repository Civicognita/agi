...
export const codeHacker: WorkerDefinition = {
  ...
  domain: "code",
  role: "hacker",
  description: "Implementation worker that writes code matching existing codebase patterns. Always followed by code.tester in the enforced chain.",
  modelTier: "capable",
  allowedTools: ["Read", "Write", "Edit", "Bash", "Glob", "Grep"],
  chainTarget: "code.tester",
  keywords: ["implement", "build", "code", "fix", "hack", "write code", "create", "prototype", "add feature", "change", "modify"],
  prompt: `---
