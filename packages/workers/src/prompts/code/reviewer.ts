...
export const codeReviewer: WorkerDefinition = {
  ...
  domain: "code",
  role: "reviewer",
  description: "Code review worker that examines changes for quality, patterns, security, and correctness. Provides structured feedback without making changes.",
  modelTier: "fast",
  allowedTools: ["Read", "Bash", "Glob", "Grep"],
  keywords: ["review", "code review", "check", "inspect", "audit code", "quality", "security review", "feedback", "diff"],
  prompt: `---
