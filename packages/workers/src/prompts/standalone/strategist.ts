...
export const standaloneStrategist: WorkerDefinition = {
  id: "strategist",
  name: "Strategist",
  domain: "strat",
  role: "strategist",
  ...
  keywords: ["strategy", "architecture", "trade-off", "evaluate", "plan approach", "risk assessment", "design system", "dependencies", "options"],
  prompt: `---
