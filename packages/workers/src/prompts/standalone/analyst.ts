...
export const standaloneAnalyst: WorkerDefinition = {
  id: "analyst",
  name: "Analyst",
  domain: "k",
  role: "analyst",
  ...
  keywords: ["analyze", "explore", "pattern recognition", "data review", "codebase exploration", "statistical summary", "dependency map"],
  prompt: `---
name: worker-analyst
description: Non-interactive analysis worker for pattern recognition, data review, and codebase exploration. Spawned by dispatch for parallel processing.
model: haiku
