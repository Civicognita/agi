...
export const standaloneResearcher: WorkerDefinition = {
  id: "researcher",
  name: "Researcher",
  domain: "k",
  role: "researcher",
  ...
  keywords: ["research", "investigate", "web search", "gather info", "context building", "API reference", "documentation lookup", "compare"],
  prompt: `---
