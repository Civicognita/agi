...
export const kAnalyst: WorkerDefinition = {
  ...
  domain: "k",
  role: "analyst",
  description: "Pattern recognition and connection analysis worker. Investigates codebases, documents, and data to find patterns, relationships, and insights.",
  modelTier: "balanced",
  allowedTools: ["Read", "Glob", "Grep"],
  keywords: ["analyze", "pattern", "research", "investigate", "insight", "dependency", "map", "find patterns", "understand", "explore"],
  prompt: `---
