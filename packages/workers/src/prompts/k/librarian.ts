...
export const kLibrarian: WorkerDefinition = {
  ...
  domain: "k",
  role: "librarian",
  description: "Indexing and retrieval worker for knowledge management. Catalogs documents, builds indexes, and retrieves relevant information for RAG workflows.",
  modelTier: "fast",
  allowedTools: ["Read", "Write", "Glob", "Grep"],
  keywords: ["index", "retrieve", "catalog", "search", "find", "document", "knowledge base", "RAG", "lookup", "organize docs"],
  prompt: `---
