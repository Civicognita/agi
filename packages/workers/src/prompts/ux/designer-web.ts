...
export const uxDesignerWeb: WorkerDefinition = {
  ...
  domain: "ux",
  role: "designer-web",
  description: "Web interface design worker. Creates UI component designs, layouts, and styling following existing design system patterns.",
  modelTier: "capable",
  allowedTools: ["Read", "Write", "Edit", "Glob", "Grep"],
  keywords: ["design", "UI", "component", "layout", "responsive", "React", "CSS", "Tailwind", "web design", "frontend", "interface", "accessibility"],
  prompt: `---
