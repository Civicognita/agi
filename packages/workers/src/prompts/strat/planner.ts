...
export const stratPlanner: WorkerDefinition = {
  ...
  domain: "strat",
  role: "planner",
  description: "Universal entry point for shortcode-triggered work. Parses raw intent and produces structured WORK.CHUNKs with phases, worker assignments, and gates for TASKMASTER.",
  modelTier: "capable",
  allowedTools: ["Read", "Glob", "Grep"],
  keywords: ["plan", "phase", "strategy", "work chunk", "orchestrate", "break down", "schedule", "roadmap", "prioritize work", "organize"],
  prompt: `---
