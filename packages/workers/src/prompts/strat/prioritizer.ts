...
export const stratPrioritizer: WorkerDefinition = {
  ...
  domain: "strat",
  role: "prioritizer",
  description: "Impact vs effort analysis worker. Evaluates and ranks work items by priority using structured criteria (ICE, RICE, MoSCoW).",
  modelTier: "fast",
  allowedTools: ["Read", "Glob", "Grep"],
  keywords: ["prioritize", "rank", "backlog", "order", "urgency", "impact", "effort", "ICE", "RICE", "MoSCoW", "score", "triage"],
  prompt: `---
