...
export const opsDeployer: WorkerDefinition = {
  id: "ops.deployer",
  name: "Operations Deployer",
  domain: "ops",
  role: "deployer",
  description: "CI/CD and release worker. Handles deployments, version bumps, release notes, and pipeline configuration.",
  modelTier: "capable",
  allowedTools: ["Read", "Write", "Edit", "Bash", "Glob", "Grep"],
  requiredTier: "sealed",
  keywords: ["deploy", "release", "version bump", "CI/CD", "pipeline", "production", "rollback", "tag", "changelog", "semver"],
  prompt: `---
