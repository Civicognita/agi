...
export const opsSyncer: WorkerDefinition = {
  id: "ops.syncer",
  name: "Operations Syncer",
  domain: "ops",
  role: "syncer",
  description: "Cross-repository synchronization worker. Handles upstream merges, fork syncing, and multi-repo coordination.",
  modelTier: "balanced",
  allowedTools: ["Read", "Write", "Bash", "Glob", "Grep"],
  keywords: ["sync", "synchronize", "upstream", "merge", "fork", "pull", "rebase", "conflict", "multi-repo", "reconcile"],
  prompt: `---
