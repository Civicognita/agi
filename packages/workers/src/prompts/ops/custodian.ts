...
export const opsCustodian: WorkerDefinition = {
  id: "ops.custodian",
  name: "Operations Custodian",
  domain: "ops",
  role: "custodian",
  description: "Cleanup and maintenance worker. Handles archival, pruning, cache clearing, and general housekeeping tasks.",
  modelTier: "fast",
  allowedTools: ["Read", "Write", "Bash", "Glob", "Grep"],
  keywords: ["cleanup", "maintenance", "archive", "prune", "cache", "housekeeping", "log rotation", "stale", "tidy", "organize"],
  prompt: `---
