/**
 * Base worker prompt template — the universal protocol injected into all workers.
 * Loaded from .claude/agents/workers/base.md at build time.
 */
export const baseWorkerPrompt = `# Worker Base Protocol
