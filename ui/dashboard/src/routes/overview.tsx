...
export default function OverviewPage() {
  ...
  // Defensive coalesce via safeArray: if an older/broken backend ever
  // returns `overview` without `recentActivity` (e.g. an un-awaited async
  // handler), render with just the live buffer instead of throwing "not
  // iterable" at runtime.
  const recentActivity = safeArray<typeof liveActivity[number]>(overview.data?.recentActivity);
